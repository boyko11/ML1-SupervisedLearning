...
class DTLearner(Learner):
    ...
    def __init__(self, criterion='gini', min_samples_leaf=1):
        self.estimator = tree.DecisionTreeClassifier(random_state=78, criterion=criterion, min_samples_leaf=min_samples_leaf)
